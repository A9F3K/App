...
export function HeaderIconEn({ color, size }: Props) {
  return (
    <Root size={size}>
      <Path
        d="M13.3005 6.50391C13.2635 6.50391 13.0782 6.50391 12.161 6.61478C11.4074 6.70587 10.0796 6.94739 9.32031 7.06162C8.0446 7.25355 7.20088 7.28785 6.63141 7.38024C6.32287 7.4303 6.72828 8.29129 7.18408 9.67467C7.48864 10.599 7.73228 12.0374 7.92154 13.1215C8.23207 14.9001 8.26088 15.7421 8.27936 15.9748C8.35053 16.871 8.67076 18.0928 8.75531 18.6992C8.8342 19.265 8.82083 19.6428 9.00673 20.7039C9.1076 21.2797 9.17472 21.8434 9.28699 22.6181C9.36147 23.132 9.43678 23.507 9.47374 23.6747C9.49179 23.7567 9.58461 23.8055 10.3803 23.6862C11.176 23.5669 12.6912 23.2713 13.5457 23.119C14.8414 22.888 15.2961 22.8177 15.7155 22.6873C15.874 22.6497 16.0958 22.6128 16.2562 22.5937C16.4166 22.5747 16.509 22.5747 16.7722 22.5187"
        stroke={color}
        strokeLinecap="round"
        strokeWidth={1.33}
        fill="none"
      />
      <Path
        d="M8.59375 15.9683C8.74158 15.9313 9.03947 15.8568 9.93904 15.5881C10.6169 15.3747 11.7441 15.0051 12.5187 14.7778C13.2934 14.5505 13.6815 14.4765 14.2493 14.4004"
        stroke={color}
        strokeLinecap="round"
        strokeWidth={1.33}
        fill="none"
      />
      <Path
        d="M15.1953 19.8934C15.1953 19.875 15.1953 19.8565 15.3801 19.0709C15.5649 18.2852 15.9345 16.733 16.2542 15.0095C16.5739 13.2859 16.8326 11.4381 16.9659 10.4215C17.0992 9.40487 17.0992 9.27552 17.1269 9.24584C17.1546 9.21616 17.21 9.29008 17.6451 10.2983C18.0802 11.3065 18.8933 13.2467 19.4322 14.6436C19.9712 16.0404 20.2114 16.835 20.3813 17.5492C20.6938 18.8623 20.7019 19.5754 20.5997 19.6781C20.5494 19.7287 20.4421 19.6885 20.4314 19.4203C20.4208 19.1521 20.4947 18.6347 20.9578 16.5849C21.4209 14.5352 22.2709 10.9688 22.7273 9.09465C23.2206 7.14656 23.2771 6.97801 23.3328 6.76411C23.3701 6.6426 23.4255 6.49477 23.4826 6.23047"
        stroke={color}
        strokeLinecap="round"
        strokeWidth={1.33}
        fill="none"
