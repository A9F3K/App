...
/**
 * Triple-column swap footer: same deal controls as 2-column {@link SwapDealActionRow},
 * with bottom-bar chrome and 40px typography.
 */
export function SwapColumnFooter() {
