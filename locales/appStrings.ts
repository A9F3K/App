...
const en = {
  ...
  "get.action.summary": "Top up {{symbol}} to app wallet",
  "get.action.summaryWithAmount": "Top up {{amount}} {{symbol}} to app wallet",
...
const ru = {
  ...
  "get.action.summary": "Пополнить {{symbol}} на кошелёк приложения",
  "get.action.summaryWithAmount": "Пополнить {{amount}} {{symbol}} на кошелёк приложения",
...
const zh = {
  ...
  "get.action.summary": "向应用钱包充值 {{symbol}}",
  "get.action.summaryWithAmount": "向应用钱包充值 {{amount}} {{symbol}}",
